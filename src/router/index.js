...
const router = new Router({
    ...
    routes: [
        ...
        },
        {
            ...
            component: () => import('../DemoPages/UserPages/AddScript.vue'),
        },
        ...
        {
            path: '/manageScriptExpiry',
            name: 'ManageScriptExpiry',
            component: () => import('../DemoPages/UserPages/ManageScriptExpiry.vue'),
        },
        {
            path: '/resetPassword',
            name: 'ResetPassword',
            meta: {layout: 'userpages'},
            component: () => import('../DemoPages/UserPages/ResetPassword.vue'),
        },
        {
            path: '/changePassword',
            name: 'ChangePassword',
